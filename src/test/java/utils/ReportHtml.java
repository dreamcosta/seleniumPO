...
public class ReportHtml extends HTMLLayout {
    ...
    String title="weiDian-weixin-html";
    ...
    public String format(LoggingEvent event) {   
        ...
        if (event.getLevel().equals(Level.INFO)) {   
            sbuf.append("<font color=\"#009933\">");   
            sbuf.append(Transform.escapeTags(String.valueOf(event.getLevel())));   
            sbuf.append("</font>");   
        } else if (event.getLevel().isGreaterOrEqual(Level.ERROR)) {   
            sbuf.append("<font color=\"#FF0033\"><strong>");   
            sbuf.append(Transform.escapeTags(String.valueOf(event.getLevel())));   
   ...
   if (locationInfo) {   
    ...
    public String getHeader() {   
        ...
        sbuf.append("<th>运行时间</th>" + Layout.LINE_SEP);   
        sbuf.append("<th>级别</th>" + Layout.LINE_SEP);   
      
        if (locationInfo) {   
            sbuf.append("<th>定位</th>" + Layout.LINE_SEP);   
        }   
   
        sbuf.append("<th>输出信息</th>" + Layout.LINE_SEP);   
        sbuf.append("</tr>" + Layout.LINE_SEP);   
